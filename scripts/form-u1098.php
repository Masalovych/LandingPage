...
function emailFormSubmission()
{
	...
	$subject = 'Заказ Небесные фонарики Праздничный';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Имя:</b></td><td>' . htmlentities($_REQUEST["custom_U1099"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	 htmlentities($_REQUEST["Email"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Количество:</b></td><td>' . htmlentities($_REQUEST["custom_U1123"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Сотовый телефон:</b></td><td>' . htmlentities($_REQUEST["custom_U1116"],ENT_COMPAT,'UTF-8') . '</td></tr>';
