...
function emailFormSubmission()
{
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Имя:</b></td><td>' . htmlentities($_REQUEST["custom_U769"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	 htmlentities($_REQUEST["Email"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Количество:</b></td><td>' . htmlentities($_REQUEST["custom_U804"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Сотовый телефон:</b></td><td>' . htmlentities($_REQUEST["custom_U810"],ENT_COMPAT,'UTF-8') . '</td></tr>';
