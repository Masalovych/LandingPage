...
function emailFormSubmission()
{
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Имя:</b></td><td>' . htmlentities($_REQUEST["custom_U1218"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	 htmlentities($_REQUEST["Email"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Сотовый телефон:</b></td><td>' . htmlentities($_REQUEST["custom_U1235"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	if($sent)
	{
		echo '{"FormResponse": { "success": true,"redirect":"zvonok.html"}}';
